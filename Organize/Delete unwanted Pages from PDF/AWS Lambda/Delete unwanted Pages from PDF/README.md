# PDF4me - Delete Unwanted Pages from PDF (AWS Lambda)

AWS Lambda function for deleting unwanted pages from PDF documents using the PDF4me API. This function removes specified pages from PDF documents based on page numbers or ranges.

## Features

- ✅ Delete unwanted pages from PDF documents based on page numbers
...
### Triggers
- **HTTP API:** `POST /delete-unwanted-pages`
- **S3:** `pdf-unwanted-pages-input-bucket` (ObjectCreated events for .pdf files)
...
```bash
curl -X POST https://your-api-gateway-url/delete-unwanted-pages \
...
Upload a PDF file to the `pdf-unwanted-pages-input-bucket` S3 bucket, and the Lambda function will automatically process it.
...
node delete_unwanted_pages_from_pdf_lambda.js
```
...
├── delete_unwanted_pages_from_pdf_lambda.js    # Main Lambda function
├── package.json                                # Dependencies and scripts
├── serverless.yml                              # AWS Lambda configuration
├── README.md                                   # This file
├── sample.pdf                                  # Sample PDF for testing
└── Delete_unwanted_pages_from_PDF_output.pdf  # Output file (generated)
```
...
```json
{
  ...
  "body": {
    ...
    "outputFileName": "Delete_unwanted_pages_from_PDF_output.pdf",
    "fileSize": 12345,
    "pageNumbers": "2-4"
  }
}
...
- **POST** `/api/v2/DeletePages` - Deletes unwanted pages from a PDF document
