...
/**
 * Rotate Page using PDF4Me API
 * Rotates specific pages in PDF documents
 * Supports both synchronous and asynchronous processing with retry logic
 */

// API Configuration - PDF4Me service for rotating specific pages
const API_KEY = "Please get the key from https://dev.pdf4me.com/dashboard/#/api-keys/";
const BASE_URL = "https://api.pdf4me.com/";
const API_ENDPOINT = `${BASE_URL}api/v2/RotatePage`;

// File paths configuration
const INPUT_PDF_PATH = "sample.pdf";                               // Input PDF file to process
const OUTPUT_PDF_PATH = "Rotate_page_PDF_output.pdf";              // Output PDF file name

// Processing configuration
const ROTATION_TYPE = "Clockwise";                                 // Options: Clockwise, CounterClockwise, UpsideDown
const PAGE_NUMBER = "1";                                           // Specific page to rotate
...
/**
 * Main function to rotate specific page in PDF
 */
async function rotatePage() {
    console.log("=== Rotating Specific Page in PDF Document ===");
    ...
    try {
        ...
        const result = await executePageRotation(payload);
        ...
        console.error(`Error in rotatePage: ${error.message}`);
        return null;
    }
}
 ...
 */
async function executePageRotation(payload) {
    try {
        ...
        console.log("Sending PDF page rotation request to PDF4me API...");
        ...
        if (response.status === 200) {
            ...
            console.log("Success: Page rotated successfully!");
        ...
        console.error(`Error in executePageRotation: ${error.message}`);
        return null;
    }
}
