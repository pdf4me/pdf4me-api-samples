...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        // Initialize the margin adder with the HTTP client, PDF file path, and API key
        var marginAdder = new PdfMarginAdder(httpClient, pdfPath, API_KEY);
...
public class PdfMarginAdder
{
    ...
    public PdfMarginAdder(HttpClient httpClient, string inputPdfPath, string apiKey)
    {
