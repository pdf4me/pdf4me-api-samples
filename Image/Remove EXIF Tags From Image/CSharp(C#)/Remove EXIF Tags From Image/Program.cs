...
/// <summary>
/// Main program class for removing EXIF tags from images
...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        var exifTagRemover = new ExifTagRemover(httpClient, imagePath, API_KEY);
        
        // Remove EXIF tags from the image
        var result = await exifTagRemover.RemoveExifTagsAsync();
...
/// <summary>
/// Class responsible for removing EXIF tags from images using the PDF4ME API
/// </summary>
    ...
    public async Task<string?> RemoveExifTagsAsync()
    {
        try
        {
            ...
            else if ((int)response.StatusCode == 202)
            {
                ...
                // Timeout if EXIF removal doesn't complete within retry limit
