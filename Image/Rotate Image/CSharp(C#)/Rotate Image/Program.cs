...
/// <summary>
/// Main program class for rotating images
/// This program demonstrates how to rotate images using the PDF4ME API
/// </summary>
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        int rotationAngle = 90;  // Update this to your desired rotation angle
        
        // Create HTTP client for API communication
        using HttpClient httpClient = new HttpClient();
        httpClient.BaseAddress = new Uri(BASE_URL);
        
        // Initialize the image rotator with the HTTP client, image path, rotation angle, and API key
        var imageRotator = new ImageRotator(httpClient, imagePath, rotationAngle, API_KEY);
        ...
        if (!string.IsNullOrEmpty(result))
            Console.WriteLine($"Rotated image saved to: {result}");
        else
            Console.WriteLine("Image rotation failed.");
    }
}

/// <summary>
/// Class responsible for rotating images using the PDF4ME API
/// </summary>
public class ImageRotator
{
    ...
    // File paths and rotation parameters
    /// <summary>
    ...
    public ImageRotator(HttpClient httpClient, string inputImagePath, int rotationAngle, string apiKey)
    {
    ...
    /// <summary>
    /// Rotates the image asynchronously using the PDF4ME API
    /// </summary>
    /// <returns>Path to the rotated image file, or null if rotation failed</returns>
    public async Task<string?> RotateImageAsync()
    {
        ...
        // Prepare the API request payload with rotation parameters
        var payload = new
        {
        ...
        else if ((int)response.StatusCode == 202)
        {
            ...
            Console.WriteLine("Timeout: Image rotation did not complete after multiple retries.");
            return null;
        }
