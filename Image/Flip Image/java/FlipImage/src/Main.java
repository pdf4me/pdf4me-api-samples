...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String inputImagePath = "Image/Flip Image/java/FlipImage/sample.jpg";
        String outputImagePath = "Image/Flip Image/java/FlipImage/Flip_image_output.jpg";
        flipImage(inputImagePath, outputImagePath);
    }

    public static void flipImage(String inputImagePath, String outputImagePath) {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                ...
                .build();
            System.out.println("Sending image flip request to PDF4me API...");
            HttpResponse<byte[]> response = httpClient.send(request, HttpResponse.BodyHandlers.ofByteArray());
            System.out.println("Response Status Code: " + response.statusCode());
            if (response.statusCode() == 200) {
                Files.write(Paths.get(outputImagePath), response.body());
                System.out.println("✓ Success! Image flipping completed!");
