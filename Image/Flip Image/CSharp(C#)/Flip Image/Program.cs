...
/// <summary>
/// Main program class for flipping images
/// This program demonstrates how to flip images using the PDF4ME API
/// </summary>
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        string orientationType = "Vertical";  // Update this to your desired flip orientation
        
        // Create HTTP client for API communication
        using HttpClient httpClient = new HttpClient();
        httpClient.BaseAddress = new Uri(BASE_URL);
        
        // Initialize the image flipper with the HTTP client, image path, orientation type, and API key
        ...
        if (!string.IsNullOrEmpty(result))
            Console.WriteLine($"Flipped image saved to: {result}");
        else
            Console.WriteLine("Image flipping failed.");
    }
}

/// <summary>
/// Class responsible for flipping images using the PDF4ME API
/// </summary>
public class ImageFlipper
{
    ...
    // File paths and flip orientation
    /// <summary>
    ...
    /// <param name="orientationType">Orientation type for flipping: "Vertical" or "Horizontal"</param>
    ...
    /// <summary>
    /// Flips the image asynchronously using the PDF4ME API
    /// </summary>
    /// <returns>Path to the flipped image file, or null if flipping failed</returns>
    public async Task<string?> FlipImageAsync()
    {
        try
        {
            ...
            // Prepare the API request payload with flipping parameters
            var payload = new
            {
            ...
            {
                // Read the flipped image content from the response
            ...
            else if ((int)response.StatusCode == 202)
            {
                ...
                // Timeout if flipping doesn't complete within retry limit
                Console.WriteLine("Timeout: Image flipping did not complete after multiple retries.");
                return null;
            }
