...
/// <summary>
/// Main program class for image flipping functionality
/// This program demonstrates how to flip images horizontally or vertically using the PDF4ME API
/// </summary>
public class Program
{
    ...
    {
        // Path to the input image file to be flipped
