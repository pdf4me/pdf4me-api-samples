...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String inputImagePath = "Image/Compress Image/java/CompressImage/sample.jpg";
        String outputImagePath = "Image/Compress Image/java/CompressImage/Compress_image_output.jpg";
    ...
    public static void compressImage(String inputImagePath, String outputImagePath) {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                ...
                .build();
            System.out.println("Sending image compression request to PDF4me API...");
            HttpResponse<byte[]> response = httpClient.send(request, HttpResponse.BodyHandlers.ofByteArray());
            System.out.println("Response Status Code: " + response.statusCode());
            if (response.statusCode() == 200) {
                Files.write(Paths.get(outputImagePath), response.body());
                System.out.println("✓ Success! Image compression completed!");
