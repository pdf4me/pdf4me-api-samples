...
def split_pdf_by_text():
    ...
    output_folder = "Split_PDF_Text_outputs"  # Output folder for split PDF files
    ...
    url = f"{base_url}api/v2/SplitByText"
    ...
    if response.status_code == 200:
        ...
        print("✓ Success! PDF text splitting completed!")
