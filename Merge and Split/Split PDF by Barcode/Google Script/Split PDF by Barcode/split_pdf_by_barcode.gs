function splitPdfByBarcode() {
  /**
   * Split a PDF file by barcode using PDF4Me API
   * Process: Read PDF file → Encode to base64 → Send API request → Poll for completion → Save split PDF files
   * PDF barcode splitting divides PDF documents at specified barcode locations
   */
  ...
  var url = baseUrl + "api/v2/SplitPdfByBarcode_old";
  ...
  try {
    ...
    var payload = {
      ...
      "barcodeString": "PDF4me Barcode Sample",                       // Barcode string to search for
