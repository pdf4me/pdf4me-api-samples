...
/// <summary>
/// Main program class for PDF splitting by barcode functionality
/// This program demonstrates how to split PDF files by barcode using the PDF4ME API
/// </summary>
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        // Example: Split PDF by QR code barcode
...
/// <summary>
/// Class responsible for splitting PDF files by barcode using the PDF4ME API
/// </summary>
public class PdfBarcodeSplitter
{
    ...
    public PdfBarcodeSplitter(HttpClient httpClient, string inputPdfPath)
    {
        ...
        _outputDirectory = inputPdfPath.Replace(".pdf", "_barcode_split_output");
    }

    /// <summary>
    /// Splits PDF by barcode asynchronously using the PDF4ME API
    /// </summary>
    ...
    /// <summary>
    /// Executes the PDF splitting by barcode operation asynchronously
    /// </summary>
    ...
    private async Task<string?> ExecuteBarcodeSplitAsync(object payload)
    {
        try
        {
            ...
            if ((int)response.StatusCode == 200)
            {
                ...
                string outputPath = Path.Combine(_outputDirectory, "barcode_split_result.zip");
