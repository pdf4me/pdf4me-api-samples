...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Protecting PDF Document ===");
        try {
            String result = protectDocument(pdfPath);
            if (result != null && !result.isEmpty()) {
                System.out.println("Protected document saved to: " + result);
            } else {
                System.out.println("Document protection failed.");
            }
        } catch (Exception e) {
    ...
    public static String protectDocument(String inputPdfPath) {
        try {
            ...
            String outputPdfPath = inputPdfPath.replace(".pdf", ".protected.pdf");
            ...
            System.err.println("Error in protectDocument: " + ex.getMessage());
            return null;
        }
    }

    private static String executeDocumentProtection(Map<String, Object> payload, String outputPdfPath) {
        try {
            String jsonPayload = convertToJson(payload);
            
            HttpRequest httpRequest = HttpRequest.newBuilder()
                .uri(URI.create(BASE_URL + "api/v2/Protect"))
            ...
            if (response.statusCode() == 200) {
                ...
                System.out.println("Timeout: Document protection did not complete after multiple retries.");
                return null;
            } else {
            ...
            System.err.println("Error in executeDocumentProtection: " + ex.getMessage());
            return null;
        }
    }
